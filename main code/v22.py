#===============================================================================
# Main Processing - Version 22
#
# Adding option for a perimeter road.
#
#===============================================================================
...
def GetCarParkPixelLinesToDrawFromPixelShape(carParkShape,pixelsPerMeter,addPerimeterRoad):
    ...
    #print shape.getVerticesCoordinates()
    parkingTilesMade,messageToPrint = tileAndTrim(newShape,tiles,listOFTuplesOfNamesOfTilesInListAndHowManyOfEach) #a list of tile shapes generated, currently in meters
