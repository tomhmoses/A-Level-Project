...
class goButton(tk.Frame):
    ...
    def buttonClicked(self): #needs finishing
        ...
        listOfGroupsOfCoordinatesForLines = processingCode.GetCarParkPixelLinesToDrawFromPixelShape(carParkShape,pixelsPerMeter)     
