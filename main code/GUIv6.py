...
#         v17: my processing code for generating the car park layout
#-------------------------------------------------------------------------------
from PIL import Image, ImageTk, ImageDraw
import Tkinter as tk
import ttk as ttk
from resizeimage import resizeimage
import v17 as processingCode
...
def drawMapImage():
    ...
    for count in range(len(listOfCoordinates)):
        #draw.elipse(first point but moved the radius away from the centre, second point but moved the radius away from the centre, fill colour)
        draw.ellipse((listOfCoordinates[count][0]-radiusOfCarParkVertices,listOfCoordinates[count][1]-radiusOfCarParkVertices,listOfCoordinates[count][0]+radiusOfCarParkVertices,listOfCoordinates[count][1]+radiusOfCarParkVertices),fill = colour)#fill  = 'rgb(0%,0%,100%)' )
        #draw.line(first point, second point)
    ...
    #I then need to delete the draw instance I created so that the memory can be cleared up to be used by other processes.
    del draw
...
class shapeVertexRemoveButton(tk.Frame):
    ...
    def buttonClicked(self):
        ...
        drawMapImage() #updates the window
        refreshMap()
