...
#
# Adding the menubar
# Fixed bug where car park shape would be incorrectly manipulated.
#
#===============================================================================
...
class goButton(tk.Frame):
    ...
    def buttonClicked(self):
        ...
        if len(carParkShape.getVertices()) < 3: #a valid shape can't have less than three vertices
            ...
            listOfGroupsOfCoordinatesForLines,messageToPrint = processingCode.GetCarParkPixelLinesToDrawFromPixelShape(carParkShapeForUseInProcessing,pixelsPerMeter)     
